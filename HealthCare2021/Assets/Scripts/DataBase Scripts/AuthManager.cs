...
public class AuthManager : MonoBehaviour
{
    ...
    {
         submitButtonRegister.interactable = (phoneNumberInput.text.Length == 10 && passwordInput.text.Length >= 4) ;
         submitButtonLogin.interactable = (phoneNumberInput.text.Length == 10 && passwordInput.text.Length >= 4);
    }
}
